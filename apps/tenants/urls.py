...
urlpatterns = [
    ...
    path('developer/addons/<str:addon_id>/', views.developer_addon_detail_view, name='developer_addon_detail'),
    path('developer/addons/<str:addon_id>/toggle/<int:institution_id>/', views.toggle_institution_addon_view, name='toggle_institution_addon'),
]
