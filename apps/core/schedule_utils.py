...
from apps.core.models import Program, FestDay, Stage, ProgramSchedule, Participation, GroupParticipation, Contestant
...
def get_program_contestants(program):
    """Return a QuerySet of Contestant objects for a given program."""
    if program.is_group:
